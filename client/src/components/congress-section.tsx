                ...
                <div className={`relative overflow-hidden ${
                  ...
                  <img 
                    ...
                    className={`w-full h-full group-hover:scale-105 transition-transform duration-700 ${
                      image.title.includes('SABCS 2024') ? 'object-cover object-center' : 'object-cover'
                    }`}
                    loading="lazy"
                  />
              ...
              <div className="flex-1 lg:w-2/5 bg-white flex flex-col">
                ...
                <div className="p-6 lg:p-8 pt-0 border-t border-gray-100">
                  <div className="flex flex-col sm:flex-row gap-3">
                    <button
                      onClick={() => {
                        const message = `Olá! Gostaria de saber mais sobre "${selectedImage.title}".`;
                        const whatsappUrl = `https://wa.me/5561992947671?text=${encodeURIComponent(message)}`;
                        window.open(whatsappUrl, '_blank');
                      }}
                      className="flex-1 bg-primary-green text-white px-6 py-3 rounded-xl font-montserrat font-semibold hover:bg-secondary-green transition-colors duration-300 flex items-center justify-center gap-2"
                    >
                    ...
                    <button
                      onClick={closeModal}
                      className="px-6 py-3 border-2 border-gray-200 text-gray-600 rounded-xl font-montserrat font-semibold hover:border-gold-primary hover:text-gold-primary transition-colors duration-300"
                    >
                      Fechar
                    </button>
                  </div>
