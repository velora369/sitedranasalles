              ...
              >
                {testimonialImages.map((imageUrl, index) => (
                  <div key={index} className="w-full flex-shrink-0 flex justify-center">
                    <div className="relative overflow-hidden cursor-pointer group max-w-fit">
                      <img
                        src={imageUrl}
                      ...
                      >
                        <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 bg-white/90 backdrop-blur-sm rounded-full p-3">
